...
LOADING_GIF = environ.get('LOADING_GIF', "https://telegra.ph/file/166a5a50e52563960e937.jpg")


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1710896723').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1710896723').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002286061910')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002815845542').split()]  # For Multiple Id Use One Space Between Each.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/R_Bots_Updates/18')
...
AUTO_FILTER_REPLY_MSG = bool(environ.get('AUTO_FILTER_REPLY_MSG', True))
